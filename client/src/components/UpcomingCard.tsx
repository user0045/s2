...
const UpcomingCard = ({
  ...
  const handleTrailer = (e: React.MouseEvent) => {
    ...
    setLocation(
      `/video-player?videoUrl=${trailerUrl || "https://sample-videos.com/zip/10/mp4/SampleVideo_1280x720_1mb.mp4"}&title=${title} - Trailer&description=Official trailer for ${title}. ${description}&duration=2h 30m`
    );
  };
